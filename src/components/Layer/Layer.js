...
class Layer extends Component {
    ...
    render() {
        ...
        if (this.props.squares != null) {
            if (this.props.squares.length >= 3) {
                front = this.props.squares.slice(0, 3)
            }

            if (this.props.squares.length >= 6) {
                right = this.props.squares.slice(3, 6)
            }

            if (this.props.squares.length >= 9) {
                back = this.props.squares.slice(6, 9)
            }

            if (this.props.squares.length === 12) {
                left = this.props.squares.slice(9, 12)
            }            
        } else if (this.props.colors != null) {
